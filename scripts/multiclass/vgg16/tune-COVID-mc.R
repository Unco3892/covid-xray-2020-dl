...
runs <- ls_runs(runs_dir = here::here("runs/multiclass/vgg16/runs")) #it could also be categorical
...
view_run(here::here("runs/multiclass/vgg16/runs/cloudml_2020_05_18_145238086-112")) # The first one drops to almost 40% at one point so it is not good
view_run(here::here("runs/multiclass/vgg16/runs/cloudml_2020_05_18_145238086-009"))
...
compare_runs(
  runs = c(
    here::here("runs/multiclass/vgg16/runs/cloudml_2020_05_17_172621619-059"), # should be modified
  here::here("runs/multiclass/vgg16/runs/cloudml_2020_05_17_172621619-057")  # should be modified
  )
...
compare_runs(
  runs = c(
    here::here("runs/multiclass/vgg16/runs/cloudml_2020_05_17_172621619-027"), # should be modified
    here::here("runs/multiclass/vgg16/runs/cloudml_2020_05_17_172621619-122")  # should be modified
  )
