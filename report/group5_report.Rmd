...
vgg16_binary %>% evaluate_generator(generator = test, steps = test$n / test$batch_size)
...
den201_binary %>% evaluate_generator(generator = test, steps = test$n / test$batch_size)
```
