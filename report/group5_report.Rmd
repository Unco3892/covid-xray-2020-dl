...
vgg16_binary <- load_model_hdf5(here::here("best_models/vgg16_binary/best_first_vgg16_binary.h5"))
```
...
vgg16_binary %>% evaluate_generator(generator = test,steps = test$n)

predicted <- vgg16_binary %>% predict_generator(generator = test, steps = test$n)
