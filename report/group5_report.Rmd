...
Depending on the test type and where it is performed, the price can be high. Furthermore, reagents are also a key components of most tests and are in short supply. China and the US are producers and exporters of reagents but both countries have been hit by the pandemic. 
...
```{r pressure, echo=FALSE, out.width = '100%', message = F}
library(here)
...
Therefore, having a cheap, fast and reliable method of X-rays analysis is our motivation.
...
|---------------------|----------------|-------------------------------------------------------|------------------------|--------------|
| **Ioannis et al.**  | Chest X-ray    | 224 COVID-19(+)<br> 700 Pneumonia<br> 504 healthy     | VGG-19                 | 93.48        |
| **Wang and Wong**   | Chest X-ray    | 53 COVID-19(+)<br> 5526 COVID-19(-)<br> 8066 Healthy  | COVID-NET              | 92.4         |
| **Sethy and Behra** | Chest X-ray    | 25 COVID-19(+)<br> 25 COVID-19(-)                     | ResNet50+<br> SVM      | 95.38        |
| **Hemdan et al.**   | Chest X-ray    | 25 COVID-19(+)<br> 25 Normal                          | COVIDX-Net             | 90.0         |
| **Narin et al.**    | Chest X-ray    | 50 COVID-19(+)<br> 50 COVID-19(-)                     | Deep CNN<br> ResNet-50 | 98.0         |
| **Ozturk et al.**   | Chest X-ray    | 125 COVID-19(+)<br> 500 No-Findings                   | DarkCovidNet           | 98.08        |
| **Ozturk et al.**   | Chest X-ray    | 125 COVID-19(+)<br> 500 Pneumonia<br> 500 No-Findings | DarkCovidNet           | 87.02        |
## Data
